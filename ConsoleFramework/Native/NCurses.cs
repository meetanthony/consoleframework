...
public static class NCurses
{
    ...
    /// </summary>
    [DllImport(NCursesLibDllFileName)]
    ...
    internal static bool BUTTON_RELEASE(UInt64 e, int x)
    {
        return ((e) & NCURSES_MOUSE_MASK(x, 001)) != 0;
    }

    internal static bool BUTTON_PRESS(UInt64 e, int x)
    {
        return ((e) & NCURSES_MOUSE_MASK(x, 002)) != 0;
    }

    internal static bool BUTTON_CLICK(UInt64 e, int x)
    {
        return ((e) & NCURSES_MOUSE_MASK(x, 004)) != 0;
    }

    internal static bool BUTTON_DOUBLE_CLICK(UInt64 e, int x)
    {
        return ((e) & NCURSES_MOUSE_MASK(x, 010)) != 0;
    }

    internal static bool BUTTON_TRIPLE_CLICK(UInt64 e, int x)
    {
        return ((e) & NCURSES_MOUSE_MASK(x, 020)) != 0;
    }

    internal static bool BUTTON_RESERVED_EVENT(UInt64 e, int x)
    {
        return ((e) & NCURSES_MOUSE_MASK(x, 040)) != 0;
    }
